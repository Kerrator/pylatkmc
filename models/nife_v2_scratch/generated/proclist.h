/* proclist.h — GENERATED from nife_v2_scratch.kmcspec.toml.
 *
 * DO NOT EDIT. Regenerate with `pylatkmc-gen build nife_v2_scratch.kmcspec.toml`.
 *
...
#define PYLATKMC_V2_MAX_REACH_K 4
